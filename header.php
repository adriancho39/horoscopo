    ...
    <header class="encabezado">
        ...
        <nav class="menu-zodiaco">
            <ul class="menu-zodiaco__lista">
                ...
                <li class="menu-zodiaco__item"><a class="menu-zodiaco__enlace" href="#">Capricornio</a></li>
                <li class="menu-zodiaco__item"><a class="menu-zodiaco__enlace" href="#">Acuario</a></li>
                <li class="menu-zodiaco__item"><a class="menu-zodiaco__enlace" href="#">Piscis</a></li>
            </ul>
        </nav>
    </header>