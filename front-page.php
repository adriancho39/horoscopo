...
<main class="inicio">
    <section class="inicio__introduccion contenedor">
        <h2 class="inicio__titulo">Los 12 Signos del Zodiaco</h2>
        <p class="inicio__texto">Explora los misterios y características de cada signo del zodiaco</p>
    </section>
    ...
    <section class="inicio__rejilla contenedor">
        ...
        <div class="signo-zodiaco"><a class="signo-zodiaco__enlace" href="#">Capricornio <img src="/wp-content/themes/Horóscopo/img/capricornio.png" alt="capricornio"></a></div>
        <div class="signo-zodiaco"><a class="signo-zodiaco__enlace" href="#">Acuario <img src="/wp-content/themes/Horóscopo/img/acuario.png" alt="acuario"></a></div>
        <div class="signo-zodiaco"><a class="signo-zodiaco__enlace" href="#">Piscis <img src="/wp-content/themes/Horóscopo/img/piscis.png" alt="piscis"></a></div>
    </section>
</main>
